...
public class PublicQuestionsSeeder(FoxTalesDbContext context, ILogger<PublicQuestionsSeeder> logger) : IClearableSeeder
{
    ...
    private static List<Question> GetQuestions(int userId, ICollection<Catalog> catalogs)
    {
...

        {
            ...
            (["PUBLIC_CATALOG_1"], ["luzne"], "Jakie danie byłoby nazwane „Specjałem ****”?"),
            ...
            (["PUBLIC_CATALOG_1"], ["luzne"], "Na co zazwyczaj brakuje czasu ****?"),
            ...
            (["PUBLIC_CATALOG_2"], ["prawda"], "O której **** zwykle wstaje?"),
            ...
            (["PUBLIC_CATALOG_2"], ["prawda"], "Jak **** ocenia swoje zdolności kulnarne w skali od 1 do 5?"),
