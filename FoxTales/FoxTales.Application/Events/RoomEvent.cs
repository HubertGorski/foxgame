...
public record PlayerLeftRoomEvent(string Code, PlayerDto PlayerToRemove) : INotification;
public record ReceiveErrorEvent(string ConnectionId, string Message, string FieldId) : INotification;
public record JoinRoomEvent(string ConnectionId, string Code) : INotification;
